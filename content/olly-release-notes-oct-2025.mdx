...
Introducing **Fast Mode**, a new capability that significantly improves response speed. Quickly switch between a detailed, slower "focus mode" and a quicker, less in-depth **Fast Mode** to get the insights you need faster2.
