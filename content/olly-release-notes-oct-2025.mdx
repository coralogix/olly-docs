...
Introducing **Fast Mode**, a new capability that significantly improves response speed. Quickly switch between a detailed, slower "focus mode" and a quicker, less in-depth **Fast Mode** to get the insights you need faster.

![Fast Mode demo](./images/fast_mode_new.gif)

### 🔗 **Chat Sharing**

Choose whether to keep a chat private or share it via a link with your Olly organization. **This feature is for all users in an Olly organization**.
