...
- In the chat repository dropdown, clicking “Configure access” redirects to GitHub.
...
<Info>If there are repositories you can access in GitHub that do not appear in the repository selection dropdown, select Configure access to authorize them, or contact a repository admin or organization owner to grant the Olly app access.
![Connect repo](./images/olly-repos.png)</Info>
