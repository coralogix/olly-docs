...
If there are repositories you can access in GitHub that do not appear in the repository selection dropdown, select **Configure Access** to authorize them, or contact a repository admin or organization owner to grant the Olly app access.

![Connect repo](./images/olly-repos.png)
