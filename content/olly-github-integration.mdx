...
5. If you do not have sufficient permissions, GitHub will generate an installation request for your organization’s administrators to review and approve.
6. A GitHub organization admin must approve the request.
