...
You can now sign in to Olly using your [Coralogix](https://docs.olly.new/content/olly-orgs-and-regions#continue-with-coralogix) account.

This streamlined sign-in experience:

- Removes the need for separate credentials

- Automatically connects Olly to your Coralogix organization and region

- Makes onboarding faster and more seamless
