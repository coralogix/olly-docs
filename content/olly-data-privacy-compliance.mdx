...
Olly is designed with security and compliance as foundational principles. The data source architecture was built to ensure permission boundaries and alignment with the security and compliance standards of the Coralogix platform.
...
Permissions are determined by your access token when you sign in with Coralogix.
