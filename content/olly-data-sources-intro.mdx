...
1. You can create a data source:
    - A personal data source may be created with a Coralogix access token or personal API key.
    - An organizational data source may be created with a team API key.
2. You select one or more relevant Coralogix teams from that region.
3. You create either a personal or an organizational data source, depending on your Olly role and the sharing settings you choose.
...
2. You can create personal or organizational data sources only by pasting an API key (personal or team, respectively).
...
- Admins can update or delete organizational data sources.
- Users can manage their own personal data sources.
...
- Each Olly organization can connect a Slack workspace to one organizational Coralogix data source.
- All queries from Slack use that data source.

To set up a Slack organizational data source, visit the [Slack Integration](https://olly.mintlify.app/content/olly-slack-integration) page.