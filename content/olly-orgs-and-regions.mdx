...
3. **Data sources can be added**: If your team is AI-enabled, Olly uses this access token when adding a data source via the Coralogix tab, limited to the token’s scope.
