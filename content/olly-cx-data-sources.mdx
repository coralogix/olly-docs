...
5. Give the data source a name (for example, `My Prod`, `Staging`) and select **Create**.
...
6. Name the data source (for example, `Production`, `EU Prod`, `Shared Sandbox`) and select **Create**.
