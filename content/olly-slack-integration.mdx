...
If another Olly organization from the same region is connected to the same Slack workspace, the integration will be updated — Olly will then operate under the most recently connected organization.
